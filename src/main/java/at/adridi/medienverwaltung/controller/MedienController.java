...
import at.adridi.medienverwaltung.db.HibernateUtil;
...
public class MedienController implements Serializable {
    ...
    public void createBarVideos() {
        ...
        this.chartBarVideosSpracheAnzahl.setTitle("Videos Anzahl - Verteilung nach Sprache");
        this.chartBarVideosSpracheAnzahl.setFill(true);
        this.chartBarVideosSpracheAnzahl.setLegendPosition("e");
        this.chartBarVideosSpracheAnzahl.setShowDataLabels(true);
        this.chartBarVideosSpracheAnzahl.setDiameter(450);
        this.chartBarVideosSpracheAnzahl.setShowDatatip(true);
            ...
            try {
                ...
                if (waehrunggruppe != null && !waehrunggruppe.isEmpty()) {
                    ...
                    if (waehrunggruppe.get(0) != 0) {
                        this.chartBarVideosSpracheAnzahl.set(w.getBezeichnung(), waehrunggruppe.get(0));
                    }
                }
        ...
        this.chartBarVideosGenreAnzahl.setTitle("Videos Anzahl - Verteilung nach Genre");
        this.chartBarVideosGenreAnzahl.setFill(true);
        this.chartBarVideosGenreAnzahl.setLegendPosition("e");
        this.chartBarVideosGenreAnzahl.setShowDataLabels(true);
        this.chartBarVideosGenreAnzahl.setDiameter(450);
        this.chartBarVideosGenreAnzahl.setShowDatatip(true);
        ...
        for (MedienVideosGenre w : waehrungenliste2) {
            try {
                ...
                if (waehrunggruppe != null && !waehrunggruppe.isEmpty() && waehrunggruppe.get(0) != null) {
                    //Alle Datumeinträge hinzufügen
                    if (waehrunggruppe.get(0) != 0) {
                        this.chartBarVideosGenreAnzahl.set(w.getBezeichnung(), waehrunggruppe.get(0));
                    }
                }
            } catch (Exception e) {
                System.out.println("Fehler in createBarVideos: " + e);
    ...
    public void createBarVideoclips() {
        ...
        this.chartBarVideoclipsSpracheAnzahl.setTitle("Videoclips Anzahl - Verteilung nach Sprache");
        this.chartBarVideoclipsSpracheAnzahl.setFill(true);
        this.chartBarVideoclipsSpracheAnzahl.setLegendPosition("e");
        this.chartBarVideoclipsSpracheAnzahl.setShowDataLabels(true);
        this.chartBarVideoclipsSpracheAnzahl.setDiameter(450);
        this.chartBarVideoclipsSpracheAnzahl.setShowDatatip(true);
        ...
        for (MedienVideoclipsSprache w : waehrungenliste) {
            try {
                ...
                if (waehrunggruppe != null && !waehrunggruppe.isEmpty() && waehrunggruppe.get(0) != null) {
                    //Alle Datumeinträge hinzufügen
                    if (waehrunggruppe.get(0) != 0) {
                        this.chartBarVideoclipsSpracheAnzahl.set(w.getBezeichnung(), waehrunggruppe.get(0));
                    }
                }
    ...
    public void updateData() {
        ...
        Credentials creds = new UsernamePasswordCredentials("BEUTZERNAME", "PASSWORT");
        client.getState().setCredentials(AuthScope.ANY, creds);
        GetMethod method = new GetMethod(this.downloadUrl);
        try {
            client.executeMethod(method);
