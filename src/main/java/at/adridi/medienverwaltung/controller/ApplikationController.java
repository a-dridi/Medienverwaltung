 ...
 * @author adridi
 */
@Named(value = "applikationController")
@ViewScoped
public class ApplikationController implements Serializable {
    ...
    private void init() {
        DAO dao = new DAO();
        List<DatenbankNotizen> notizList = dao.getDatenbankNotiz("Applikation_Notizen_Bemerkungen");
    ...
    public void speichernNotiz() {
        ...
        if (this.dbnotizEintrag != null) {
            ...
            this.dbnotizEintrag.setTabelle("Applikation_Notizen_Bemerkungen");
            ...
            n.setTabelle("Applikation_Notizen_Bemerkungen");
            n.setDatum(new Date());
